...
2. _What Share of Patents Is Commercialized?_ (with Po-Hsuan Hsu, You-Na Lee, and John P. Walsh)  
   ...
   <details>
     <summary>Abstract</summary>
     <div class="abstract-body">
       This paper develops a text-based measure of U.S. patent commercialization, trained on labels from three inventor surveys and applied at scale using modern patent-text embeddings. We benchmark BERT for Patents, PaECTER, PatSPECTER, and Gemini across multiple patent-text fields, including title/abstract, claims, brief summary, and combined text, and compare a broad set of classifiers. Our preferred model achieves strong predictive performance, with ROC-AUC of 84.9% and PR-AUC of 90.4%. To improve transparency, we convert SHAP-ranked embedding into patent phrases, making transformer-based predictions interpretable. We further validate the predictions using patent renewals and forward citations. The resulting estimates enable systematic analysis of commercialization patterns and how patented inventions move toward market use.
     </div>
   </details>
